...
public class ModREIClientPlugins implements REIClientPlugin {
    ...
    public void registerScreens(ScreenRegistry registry) {
        ...
        registry.registerClickArea(screen -> new Rectangle(48,45,24,12), DimensionalTunerScreen.class,
                DimensionalTunerCategory.DIMENSIONAL_TUNER);
        registry.registerClickArea(screen -> new Rectangle(48,35,24,12), EnergyDisintegratorScreen.class,
                EnergyDisintegratorCategory.ENERGY_DISINTEGRATOR);
    }
}
