...
public final class LootTableEvents {
	 ...
	 * We'll add a new diamond {@linkplain net.minecraft.class_55 loot pool} to the cobblestone loot table
	...
	public interface Replace {
		 ...
		 */
		@Nullable
		class_52 replaceLootTable(class_5321<class_52> key, class_52 original, LootTableSource source, class_7225.class_7874 registries);
	}
	...
	public interface Modify {
		 ...
		 * @param registries      the registry wrapper lookup
		 */
		void modifyLootTable(class_5321<class_52> key, class_52.class_53 tableBuilder, LootTableSource source, class_7225.class_7874 registries);
	}
	...
	public interface Loaded {
		 ...
		 */
		void onLootTablesLoaded(class_3300 resourceManager, class_2378<class_52> lootRegistry);
	}
}
